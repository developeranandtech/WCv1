...
from WatchingCenterbot.Utils import Media, get_file_details 
from WatchingCenterbot.Broadcast import broadcast
from WatchingCenterbot import ABOUT
from WatchingCenterbot.Channel import handle_user_status
...
async def start(bot, message):
    ...
    if usr_cmdall1.startswith("/start WCv1"):
        if AUTH_CHANNEL:
